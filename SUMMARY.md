...
* [架构决策记录](architecture/adr/README.md)
  ...
  * [0015 - Short Lived Browser Services](architecture/adr/short-lived-browser-services.md)
  * [0016 - Move Decryption and Encryption to Views](architecture/adr/decryption-in-views.md)
  * [0017 - Use Swift to build watchOS app](architecture/adr/watchos-use-swift.md)
  * [0018 - Feature management](architecture/adr/feature-management.md)
  * [0019 - Adoption of Web Push](architecture/adr/adopt-web-push.md)
  * [0020 - Observability with OpenTelemetry](architecture/adr/observability-with-opentelemetry.md)
  * [0021 - Logging to Standard Output](architecture/adr/standard-output-logging.md)
* [Web 客户端架构](architecture/clients/README.md)
  ...
  * [服务层](architecture/clients/services/README.md)
    ...
    * [实施](architecture/clients/services/implementation.md)
