...
* [服务器](docs/server/README.md)
  ...
  * [=单点登录(SSO)](docs/server/sso/README.md)
    * [=本地 IdP](docs/server/sso/local.md)
    * [=Okta](docs/server/sso/okta.md)
...
* [客户端](docs/clients/README.md)
  ...
  * [桌面端](docs/clients/desktop/README.md)
    * [=Mac App Store Dev](docs/clients/desktop/mac.md)
    * [=Microsoft Store](docs/clients/desktop/microsoft-store.md)
  ...
  * [移动端](docs/clients/mobile/README.md)
    ...
    * [=iOS 移动应用程序](docs/clients/mobile/ios.md)
