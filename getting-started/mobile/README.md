...
请参阅 [Android 移动应用程序](net-maui-legacy/android.md)页面以设置 Android 开发环境。

## iOS 开发 <a href="#ios-development" id="ios-development"></a>

请参阅 [iOS 移动应用程序](net-maui-legacy/ios.md)页面以设置 iOS 开发环境。

## watchOS 开发 <a href="#watchos-development" id="watchos-development"></a>

请参阅 [watchOS 应用程序](net-maui-legacy/watchos.md)页面来设置 watchOS 开发环境。
